<?php
namespace backend\components\treelist;
...
class TreeList extends Widget
{
	...
	public function run()
	{
		$this->view->registerCssFile('/libs/TreeList/css/treeList.css');
		$this->view->registerJsFile('/libs/TreeList/js/treeList.js',['depends' => [\yii\web\JqueryAsset::className()]]);
