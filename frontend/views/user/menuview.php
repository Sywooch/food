...
<div class="g-flexMiddleChild middleWrapper">
	...
	<div class="menuTop">
		...
		<div>
			...
			<?= Html::a('Редактировать', ['user/menuupdate', 'id' => $product->id], ['class' => 'g-link g-link_mr20']) ?>
		</div>
	</div>
						...
						<h4 class="form__header">Общая информация</h4>
							...
							<?php if ($product->dish->video): ?>
								...
								<div class="form__section">
									<div class="form__line form__line_pl30 section_810">
										<!-- <div class="form__video form__video_wcalc260 form__video_ml30 section_dib section_810">
											<a href="#" class="form__video_inner">
											...
											<ul class="video">
												<li class="blog__item section_500">
													<!-- <div class="blog__lineBox ">
														<h3 class="blog__header">Видеоблог 1</h3>
													...
													<!-- <div class="blog__tagsBox">
														<div class="blog__tag">Тег повара</div>
														<div class="blog__tag">Тег повара</div>
														<div class="blog__tag">Тег повара</div>
														<div class="blog__tag">Тег повара</div>
														<div class="blog__tag">Тег повара</div>
							...
							<div class="form__section">
								<div class="form__line form__line_center">
									<a href="<?= Url::to(['user/menuupdate', 'id' => $product->id]) ?>" class="g-link g-link_big">Редактировать</a>
								</div>
							</div>
