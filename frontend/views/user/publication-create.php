...
<div class="g-flexMiddleChild middleWrapper">
	...
	<div class="middleWrapper__container">
		...
		<div class="headerBox">
			<h1 class="headerBox__title">Добавление статьи</h1>
		</div>

		<div class="blog">
			<form action="<?= Url::to(['user/publication-create']) ?>" method="post" enctype="multipart/form-data">
						...
						<?php if ($publication->publicationtags): ?>
							<?php foreach ($publication->publicationtags as $key => $pt): ?>
								<div class="blog__tag blog__tag_edit js_publicationtag_tag">
									...
									<div class="blog__tagText"><?= $pt->header ?></div><div class="blog__delete"></div>
								</div>
							<?php endforeach ?>
						<?php endif ?>
				...
				<div class="blog__buttons">
					<input type="submit" name="submitform" class="g-button g-button_green g-m_r15" value="Добавить">
				</div>
			</form>
			...
			<div id="js_publicationtag_template" style="display: none;">
				<div class="blog__tag blog__tag_edit js_publicationtag_tag">
					...
					<div class="blog__tagText">??header??</div><div class="blog__delete"></div>
				</div>
			</div>
