<div id="js_phonenumber_for_insert">
	...
	<?php if (count($phonenumber)): ?>

		<?php foreach ($phonenumber as $key => $p): ?>
			
			<?php $allkey+= $key; ?>

			<div class="js_phonenumber_exist">
				<div class="form__line">
					<input name="ProfileCookForm[leftphonenumber][]" type="hidden" value="<?= $p->id ?>">
		...
		<?php if (count($newphonenumber)): ?>

			<?php foreach ($newphonenumber as $key => $p): ?>
